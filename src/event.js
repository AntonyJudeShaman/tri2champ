        ...
        >
          <div className="menu-items pb-20">
            {menuItems.map((item, index) => {
              ...
              return (
                <div key={index} className="menu-items" style={{fontWeight:'500', fontSize:'2.3vh'}}>
                  <h1
                    className="menu-title  pt-2"
                    style={{ textAlign: "center", fontSize: "6vh", fontWeight:'800' }}
                  >
                    {item.itemName}
                  </h1>
                  {imageUrl && (
                  ...
                  <p className="event-field" style={{fontWeight:'800'}}>{item.price}</p>
                  {imageUrl1 && (
                    <div>
                      <img
                        src={imageUrl1}
                  ...
                  <p className="event-field" style={{fontStyle:'', fontWeight:'unset'}}>{item.field1}</p>
                  {imageUrl2 && (
                    <div>
                      <img
                        src={imageUrl2}
                  ...
                  <p className="event-field" style={{fontWeight:'800'}}><i>{item.field2}</i></p>
                  {imageUrl3 && (
                    <div>
                      <img
                        src={imageUrl3}
